        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="headphone-about-content">
                    <h2>Buana Care</h2>
                    <p>Buana care kami bergerak di bidang penjualan produk masker, dengan berbagai macam motif yang
                        menarik dan nyaman dipakai, produk tersedia berupa produk jadi atau system pre order, kami juga
                        memberikan keunggulan produk diantaranya : </p>
                    <ul>
